...
const modal=` <div class="modal fade " id="meal${this._meal.idMeal}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                          ...
                          <div class=row>                                                              
                            <div class="col-md-12">
                               <div class="p-3 center text-center">
                                 ...
                                 <iframe class="w-100" style="height: 30rem;" src="https://www.youtube.com/embed/${youtubeembedlink}"></iframe>
                                </div>
                            </div>      
                          </div>  
                        </div>
        ...
        this.innerHTML=`
        <!-- search result -->
        <div class="col-md-3 pb-3" data-toggle="modal" data-target="#meal${this._meal.idMeal}">
          <div class="card pointer center" style="width: 18rem; margin-left:auto; margin-right:auto; display:block;">
